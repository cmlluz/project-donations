...
class NecessityPage extends StatefulWidget {
  const NecessityPage({Key? key}) : super(key: key);

  @override
  State<NecessityPage> createState() => _NecessityPage();
}

class _NecessityPage extends State<NecessityPage> {
